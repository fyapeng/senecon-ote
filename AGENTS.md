...
- Keep the homepage focused on the three-volume structure, PDF downloads, the preface reading route, and companion code. Long content belongs on `/preface/` and `/code/`.
